...
export default function Home() {
    const categories = [
        ...
        {
            name: "JAVA / SPRING",
            description: "Java와 Spring 관련 자료와 질문을 공유합니다.",
            icon: <FaJava className="text-6xl sm:text-8xl"/>,
            path: "/java-spring"
        },
        {
            name: "HTML / CSS",
            description: "웹 디자인과 관련된 이야기들을 나눕니다.",
            icon: <FaHtml5 className="text-6xl sm:text-8xl"/>,
            path: "/html-css"
        },
        {
        ...
        {
            name: "DATA ANALYSIS",
            description: "데이터 분석과 관련된 정보와 팁을 공유합니다.",
            icon: <FaRegChartBar className="text-6xl sm:text-8xl"/>,
            path: "/data-analysis"
        },
        {
            name: "CLOUD",
            description: "클라우드 컴퓨팅과 관련된 이야기들을 나눕니다.",
            icon: <FaCloud className="text-6xl sm:text-8xl"/>,
            path: "/cloud"
        },
        {
            name: "AI",
            description: "인공지능에 대한 정보와 경험을 공유합니다.",
            icon: <FaRobot className="text-6xl sm:text-8xl"/>,
            path: "/ai"
        }
    ];

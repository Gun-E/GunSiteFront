...
export default function Contact() {
    return (
        <section className="relative mx-auto flex min-h-[100svh] max-w-[1120px] flex-col items-center justify-center bg-black px-6 py-24 text-center md:px-10 md:py-36">
            <div className="pointer-events-none absolute left-1/2 top-1/2 h-[560px] w-[min(128vw,980px)] -translate-x-1/2 -translate-y-1/2 rounded-full bg-[radial-gradient(circle,rgba(96,165,250,0.18)_0%,rgba(96,165,250,0.085)_34%,rgba(96,165,250,0.032)_58%,rgba(96,165,250,0)_82%)] mix-blend-screen" />
            <motion.div
